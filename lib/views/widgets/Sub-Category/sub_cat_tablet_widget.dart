        ...
        children: [
          Expanded(
            child: ListView.builder(
              itemCount: SubTabletCategory.listOfTablets.length,
                  ...
                  child: Row(
                    ...
                    children: [
                      ClipRRect(
                        ...
                        //!Image
                        child: Image.asset(
                          SubTabletCategory.listOfTablets[index].imageUrl,
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            //!title
                            Text(
                              SubTabletCategory.listOfTablets[index].title,
                            ...
                            //!Price
                            Text(
                              SubTabletCategory.listOfTablets[index].price,
                              style: GoogleFonts.raleway(
                                color: AppColors.whiteColor,
                                fontSize: Dimensions.fontSize18,
                              ),
                            ...
                            //!FreeShipping
                            Text(
                              SubTabletCategory.listOfTablets[index].shipping,
                              style: GoogleFonts.raleway(
                            ...
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: List.generate(
                                SubTabletCategory.listOfTablets[index]
