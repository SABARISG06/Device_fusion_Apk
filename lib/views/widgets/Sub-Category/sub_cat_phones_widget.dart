          ...
          children: [
            Expanded(
              child: ListView.builder(
                itemCount: SortingListController.instance.mobileProduct.length,
                        ...
                        ClipRRect(
                          ...
                          child: Image.asset(
                            SortingListController
                                .instance.mobileProduct[index].imageUrl,
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                SortingListController
                                    .instance.mobileProduct[index].title,
                              ...
                              Text(
                                SortingListController
                                    .instance.mobileProduct[index].price,
                                style: GoogleFonts.raleway(
                                  color: AppColors.whiteColor,
                                  fontSize: Dimensions.fontSize18,
                                ),
                              ...
                              Text(
                                SortingListController
                                    .instance.mobileProduct[index].shipping,
                                style: GoogleFonts.raleway(
