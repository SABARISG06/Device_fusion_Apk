...
class LaptopCarousel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.find<ProductCarosuelController>();
    return Container(
              ...
              children: [
                    ...
                    child: Card(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          //* title
                          CustomText(
                            text: LaptopItems.listOfProducts[index].title,
                          ...
                          //* Amount
                          CustomText(
                            text: LaptopItems.listOfProducts[index].amount,
                            size: Dimensions.fontSize16,
                            fontWeight: FontWeight.w700,
                ...
                Align(
                  ...
                  child: CircleAvatar(
                    ...
                    backgroundImage:
                        AssetImage(LaptopItems.listOfProducts[index].imageUrl),
                  ),
                ),
                //!Arrow icon
                Positioned(
