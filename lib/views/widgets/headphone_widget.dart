...
class HeadPhonesCarousel extends StatelessWidget {
                    ...
                    child: Card(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          //* title
                          CustomText(
                            text: HeadPhonesItems.listOfProducts[index].title,
                          ...
                          //* Amount
                          CustomText(
                            text: HeadPhonesItems.listOfProducts[index].amount,
                            size: Dimensions.fontSize16,
                            fontWeight: FontWeight.w700,
                ...
                Align(
                  ...
                  child: CircleAvatar(
                    ...
                    backgroundImage: AssetImage(
                        HeadPhonesItems.listOfProducts[index].imageUrl),
                  ),
                ),
                //!Arrow icon
                Positioned(
