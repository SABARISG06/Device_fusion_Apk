...
class WearableCarousel extends StatelessWidget {
                    ...
                    child: Card(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          //* title
                          CustomText(
                            text: WearableItems.listOfProducts[index].title,
                          ...
                          //* Amount
                          CustomText(
                            text: WearableItems.listOfProducts[index].amount,
                            size: Dimensions.fontSize16,
                            fontWeight: FontWeight.w700,
                ...
                Align(
                  ...
                  child: CircleAvatar(
                    ...
                    backgroundImage: AssetImage(
                        WearableItems.listOfProducts[index].imageUrl),
                  ),
                ),
                //!Arrow icon
                Positioned(
