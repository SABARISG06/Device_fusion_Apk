...
import 'package:device_fusion/views/widgets/Sub-Category/sub_cat_phones_widget.dart';
...
class CategoryPhones extends StatelessWidget {
  const CategoryPhones({super.key});
  ...
  Future<void> bottomSheet() async {
    ...
    return Get.bottomSheet(SortingBottomSheet(
      onApplyBtn: () {
        SortingListController.instance.isPhoneSorting();
        Get.back();
      },
      onClearBtn: () {
