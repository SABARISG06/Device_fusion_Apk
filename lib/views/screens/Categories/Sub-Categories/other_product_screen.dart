...
import 'package:device_fusion/views/widgets/Sub-Category/sub_api_products_widget.dart';
...
class RestApiProduct extends StatelessWidget {
  ...
  Future<void> bottomSheet() async {
    ...
    return Get.bottomSheet(SortingBottomSheet(
      onApplyBtn: () {
        SortingListController.instance.isRestAPISorting();
        Get.back();
      },
      onClearBtn: () {
